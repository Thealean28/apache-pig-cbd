...
-- Contar cuantas veces se ha pagado con tarjeta de debito
debit_payments = FILTER data BY Type == 'DEBIT';
num_debit_payments = FOREACH (GROUP debit_payments ALL) GENERATE COUNT(debit_payments);

-- Mostrar los resultados
DUMP num_debit_payments;
